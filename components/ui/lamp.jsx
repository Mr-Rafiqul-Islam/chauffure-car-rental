...
export default function PageHeader({ pageName, subheading }) {
  return (
    <LampContainer>
      <motion.h1
      ...
      <motion.h2
        ...
        className="mt-4 bg-gradient-to-br from-slate-300 to-slate-500 py-4 bg-clip-text text-center text-3xl font-medium tracking-tight text-transparent md:text-6xl"
      >
        {subheading}
      </motion.h2>
    </LampContainer>
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="absolute inset-auto right-1/2 h-56 w-[90%] md:w-[30rem] overflow-visible bg-gradient-conic from-cyan-500 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
          >
          ...
          <motion.div
            ...
            className="absolute inset-auto left-1/2 h-56 w-[90%] md:w-[30rem] bg-gradient-conic from-transparent via-transparent to-cyan-500 text-white [--conic-position:from_290deg_at_center_top]"
          >
          ...
          <motion.div
            ...
            className="absolute inset-auto z-50 h-0.5 w-full max-w-lg -translate-y-[7rem] bg-cyan-400 "
          ></motion.div>
