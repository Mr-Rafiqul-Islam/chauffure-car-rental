...
const servicesData = [
  {
    ...
    description: 'Reliable and punctual airport transfers to get you to your destination on time and in style.',
    link: '/services',
  },
  {
    title: 'Special Events',
    imageUrl: '/assets/services/Special Events and Conferences.png',
    description: 'Arrive at your special event, conference, or gala with elegance and sophistication.',
    link: '/services',
  },
  {
    title: 'Wedding Chauffeurs',
    imageUrl: '/assets/services/Wedding Chauffeurs.png',
    description: 'Make your special day unforgettable with our luxurious and professional wedding chauffeur services.',
    link: '/services',
  },
  {
    title: 'Corporate Transfers',
    imageUrl: '/assets/services/Corporate Transfers.jpeg',
    description: 'Impress your clients and colleagues with our premium corporate transport solutions.',
    link: '/services',
  },
  {
    title: 'Winery Tours',
    imageUrl: '/assets/services/others service.png',
    description: 'Explore the finest wineries in comfort and luxury with our chauffeured winery tours.',
    link: '/services',
  },
  {
    title:'Tourist Attraction Hire',
    imageUrl: '/assets/services/Tourist Attraction Hire.png',
    description: 'Discover the wonders of nature and culture with our chauffeured winery tours.',
    link: '/services',
  }
];
    ...
    <section className="lg:px-20 md:px-10 px-5 py-10">
      <div className="mx-auto flex justify-center object-center px-4 py-16 sm:py-24 lg:max-w-7xl">
        <div className="flex flex-col justify-center items-center">
          {/* <h2 className="text-4xl font-semibold tracking-tight text-ivory sm:text-5xl lg:text-6xl">
            Services
          </h2> */}
          <TextGenerateEffect words={"Our Services"} className='text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-highlight to-bsilver bg-clip-text text-transparent'/>
              ...
              >
                <div className="relative lg:h-[400px] lg:w-96 md:h-[365px] md:w-60 sm:h-[365px] sm:w-60 h-[450px] w-[300px] rounded-xl shadow-xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                  ...
                  <div className="absolute inset-0 translate-y-[78%] px-8 text-center">
                    <p className="font-dmserif text-xl font-bold text-white">{service.title}</p>
                  </div>
