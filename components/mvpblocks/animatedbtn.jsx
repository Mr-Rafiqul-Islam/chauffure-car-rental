...
export default function AnimatedBtn1({ children, ...rest }) {
  return (
    <div className="flex items-center justify-center">
      <button className="bubbleeffectbtn" type="button" {...rest}>
        <style jsx>{`
          .bubbleeffectbtn {
            min-width: 130px;
            height: 40px;
          ...
          .bubbleeffectbtn:after {
            ...
            transition: all 0.3s ease;
            /* Changed hover/after background gradient */
          ...
          .bubbleeffectbtn:active {
            ...
            /* Changed active background to match initial state */
            background: linear-gradient(45deg, #D4AF37, #B87333);
          }
